...
*Bungee Color* contains experiments with the various color font formats out there. These fonts were originally built with Jens Kutílek’s [RoboChrome](https://github.com/fontfont/RoboChrome), and produced with help from [Roel Nieskens](https://pixelambacht.nl), with additional contributions in 2023 by [Just van Rossum](http://github.com/justvanrossum/) and [Marte Verhaegen](https://github.com/martelahaie/).


[Check out the docs](https://github.com/djrrb/bungee/tree/master/documentation) to learn more about how to use Bungee’s chromatic layers, vertical forms, stylistic alternates, and ornaments.
